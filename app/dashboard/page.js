        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-6 mb-8">
              <div className="bg-white rounded-lg border border-gray-200 p-3 lg:p-6 hover:border-blue-300 transition-all duration-300">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-3 lg:p-6 hover:border-orange-300 transition-all duration-300">
                <div className="flex items-center">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-3 lg:p-6 hover:border-purple-300 transition-all duration-300">
                <div className="flex items-center">
                  <div className="p-2 lg:p-3 bg-purple-100 rounded-lg">
                    <Send className="w-4 h-4 lg:w-6 lg:h-6 text-purple-600" />
                  </div>
                  <div className="ml-3 lg:ml-4 min-w-0 flex-1">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-3 lg:p-6 hover:border-green-300 transition-all duration-300">
                <div className="flex items-center">
                ...
                {loading ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                      ...
                      <button
                        onClick={() => router.push('/editor/new')}
                        className="inline-flex items-center px-6 py-3 bg-white border-2 border-gray-300 text-gray-700 rounded-lg hover:border-blue-500 hover:text-blue-600 transition-all duration-300 font-medium"
                      >
                  ...
                  <>
                            ...
                            >
                              ...
                              <td className="py-4 px-4">
                                <div className="flex items-center space-x-2">
                                  ...
                                  <button className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-50 rounded-lg transition-all duration-300">
                    ...
                    <div className="lg:hidden space-y-4">
                      {filteredDocuments.map((doc, index) => (
                        <div 
                          key={doc.id} 
                          className="bg-white rounded-lg border border-gray-200 p-4 hover:border-gray-300 transition-all duration-300"
                          style={{ animationDelay: `${index * 100}ms` }}
                        >
