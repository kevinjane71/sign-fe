                              ...
                              <td className="px-4 py-3" style={{width: '15%'}}>
                                <div className="flex items-center space-x-2">
                                  ...
                                  <button
                                    ...
                                    className="inline-flex items-center px-2 py-1.5 border border-red-300 text-xs font-medium rounded text-red-700 bg-white hover:bg-red-50 hover:scale-105 transition-all duration-200"
                        ...
                        {documents.map((doc, index) => (
                          ...
                          >
                            ...
                            <div className="mt-3 flex space-x-2">
                              ...
                              <button
                                onClick={() => handleDeleteDocument(doc.id)}
                                className="flex-1 inline-flex items-center justify-center px-3 py-2 border border-red-300 text-xs font-medium rounded text-red-700 bg-white hover:bg-red-50 transition-colors"
                              >
