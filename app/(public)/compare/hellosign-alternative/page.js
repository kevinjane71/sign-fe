...
export const metadata = {
  title: 'Best HelloSign Alternative 2025 | eSignTap - Save 60%',
  description: 'Switch from HelloSign to eSignTap. Same great features, 60% lower price. Compare features and pricing side by side.',
  keywords: 'HelloSign alternative, Dropbox Sign alternative, cheaper than HelloSign, HelloSign competitor',
  alternates: { canonical: 'https://esigntap.com/compare/hellosign-alternative' },
  openGraph: {
    title: 'Best HelloSign Alternative 2025 | eSignTap',
    description: 'Compare eSignTap vs HelloSign. Same features, 60% lower price.',
    url: 'https://esigntap.com/compare/hellosign-alternative',
    siteName: 'eSignTap',
    type: 'website',
  },
}

const competitor = 'HelloSign (Dropbox Sign)'
const competitorShort = 'HelloSign'
const competitorPrice = '$20/mo'
