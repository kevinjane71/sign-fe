...
export const metadata = {
  title: 'Best DocuSign Alternative 2025 | eSignTap - Save 70%',
  description: 'Looking for a DocuSign alternative? eSignTap offers the same features at 70% less cost. Compare features, pricing, and see why businesses are switching.',
  keywords: 'DocuSign alternative, cheaper than DocuSign, DocuSign competitor, best DocuSign alternative 2025, switch from DocuSign',
  alternates: { canonical: 'https://esigntap.com/compare/docusign-alternative' },
  openGraph: {
    title: 'Best DocuSign Alternative 2025 | eSignTap',
    description: 'Compare eSignTap vs DocuSign. Same features, 70% less cost.',
    url: 'https://esigntap.com/compare/docusign-alternative',
    siteName: 'eSignTap',
    type: 'website',
  },
}

const competitor = 'DocuSign'
const competitorPrice = '$25/mo'
const ourPrice = 'From $4.99/mo'
const savings = '70'

const comparisonRows = [
  { feature: 'Starting Price', us: '$4.99/mo', them: '$25/mo', usGood: true, themGood: false },
...
const faqs = [
  {
    q: `Is eSignTap really as good as ${competitor}?`,
    a: `Yes! eSignTap provides all the core e-signature features you rely on with ${competitor} — legally binding signatures, audit trails, templates, multi-signer workflows, and more. Many businesses have switched and found eSignTap simpler to use while saving significantly on costs.`,
  },
  {
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-500 mb-12 text-lg">
            See how eSignTap stacks up against {competitor}
          </p>
      ...
      <section className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-white/80 text-lg mb-10 max-w-2xl mx-auto">
            Join thousands of businesses that have already switched from {competitor} to eSignTap.
          </p>
          <Link
            href="/login"
