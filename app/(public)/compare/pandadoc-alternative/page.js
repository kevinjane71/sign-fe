...
export const metadata = {
  title: 'Best PandaDoc Alternative 2025 | eSignTap - Save 65%',
  description: 'Looking for a PandaDoc alternative? eSignTap provides powerful e-signatures at 65% lower cost. Compare features and pricing.',
  keywords: 'PandaDoc alternative, cheaper than PandaDoc, PandaDoc competitor, PandaDoc replacement',
  alternates: { canonical: 'https://esigntap.com/compare/pandadoc-alternative' },
  openGraph: {
    title: 'Best PandaDoc Alternative 2025 | eSignTap',
    description: 'Compare eSignTap vs PandaDoc. Powerful e-signatures at 65% less.',
    url: 'https://esigntap.com/compare/pandadoc-alternative',
    siteName: 'eSignTap',
    type: 'website',
  },
}

const competitor = 'PandaDoc'
const competitorPrice = '$35/mo'
const ourPrice = 'From $4.99/mo'
const savings = '65'

const comparisonRows = [
  { feature: 'Starting Price', us: '$4.99/mo', them: '$35/mo', usGood: true, themGood: false },
